...
<div class="wrapper w-100" style="max-width: 100%!important;">
    <!-- Navbar -->
...
{{--        </a>--}}
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
                <div class="image">
                    <img src="{{ asset('images/behinavalogo.png') }}"  class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                    <a href="https://behinavagancy.site" class="d-block">پنل وایرال اینستاگرام</a>
                </div>
            </div>
